...
my_axis = axis();
text(1.5, my_axis(4)*1.04, '0-15 mmHg', 'Fontsize', font_size, ...
	'Horizontalalignment', 'center');
text(3.5, my_axis(4)*1.04, '0-30 mmHg', 'Fontsize', font_size, ...
	'Horizontalalignment', 'center');
text(5.5, my_axis(4)*1.04, '0-160 mmHg', 'Fontsize', font_size, ...
	'Horizontalalignment', 'center');
